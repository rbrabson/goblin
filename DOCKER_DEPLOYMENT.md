...
services:
  goblin:
    ...
    environment:
      ...
      DISCORD_BANK_THEME: ${DISCORD_BANK_THEME:-"clash"}
      DISCORD_BLACKJACK_THEME: ${DISCORD_BLACKJACK_THEME:-"clash"}
      DISCORD_GUILD_THEME: ${DISCORD_GUILD_THEME:-"clash"}
      DISCORD_HEIST_THEME: ${DISCORD_HEIST_THEME:-"clash"}
      DISCORD_PAYDAY_THEME: ${DISCORD_PAYDAY_THEME:-"clash"}
      DISCORD_RACE_THEME: ${DISCORD_RACE_THEME:-"clash"}
...
| `DISCORD_BANK_THEME` | Default bank theme | No | `clash` |
| `DISCORD_BLACKJACK_THEME`  | Default blackjack theme | No | `clash` |
| `DISCORD_GUILD_THEME`  | Default guild theme | No | `clash` |
| `DISCORD_HEIST_THEME`  | Default heist theme | No | `clash` |
| `DISCORD_PAYDAY_THEME`  | Default payday theme | No | `clash` |
